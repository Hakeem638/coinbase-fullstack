...
import { mockBinanceTickerData, mockCurrencyConversion } from "../data/mock/binance";
...
const CryptoTable = () => {
  ...
  const fetchPrices = useCallback(async () => {
    // Return mock data instead of fetching from Binance
    return mockBinanceTickerData;
  }, []);
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Use mock currency conversion instead of fetching
        ghsRate.current = mockCurrencyConversion.usd.ghs ?? FALLBACK_GHS;
  ...
  // No polling needed - using static mock data
  useEffect(() => {
    return () => {};
